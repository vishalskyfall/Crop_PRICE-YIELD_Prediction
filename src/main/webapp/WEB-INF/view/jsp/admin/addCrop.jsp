  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="/admin/loadCrop"> Add Crop</a></li>
      </ol>
    </section>
      ...
      <div class="box">
       <!--  <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<f:form novalidate="novalidate"  action="/admin/addCrop" method="post" enctype="multipart/form-data" modelAttribute="cropVO"  >
			...
			<div class="form-group" style="margin-bottom: 3.429rem;">
			 <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
				<div class="col-lg-12 col-12">								
						...
						<div class="form-group" style="margin-bottom: 3.429rem;">
							<h5>Crop Name<span class="text-danger">*</span></h5>
							<div class="controls">
								<f:input path="cropName" placeholder="Crop Name" type="text" name="text" class="form-control" required="required" data-validation-required-message="crop name is required"></f:input> </div>
