    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Manage State</a></li>
         <li class="breadcrumb-item active"><a href="/admin/loadState"> Add State</a></li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	...
            	<f:form novalidate="novalidate"  action="/admin/addState" modelAttribute="stateVO"  >
			 ...
			 <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
							<h5> Country Name<span class="text-danger">*</span></h5>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<f:input path="stateName" placeholder="State Name"
												type="text" name="text" class="form-control"
												required="required"
												data-validation-required-message="state name is required"></f:input>
										</div>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										<h5>
											State Description <span class="text-danger">*</span>
										</h5>
										<div class="controls">
											<f:textarea path="stateDescription" name="textarea"
												id="textarea" class="form-control" required="required"
												placeholder="State Description"
												data-validation-required-message="state description is required"></f:textarea>
										</div>
									</div>
