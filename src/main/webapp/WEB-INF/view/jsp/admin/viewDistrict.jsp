    ...
    <section class="content-header">
          <h1>Manage District</h1>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="/admin/viewDistrict">View District</a></li>
				</ol>
			</section>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">View District</h3>
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						<%@taglib uri="http://java.sun.com/jstl/core_rt"
															prefix="c"%>
							<c:forEach items="${districtList}" var="district" varStatus="j">
							<tr>
																<td>${j.count}</td>
																<td>${district.districtName}</td>
																<td>${district.stateVO.stateName }</td>
																<td>${district.countryVO.countryName}</td>
																
																<td>${district.districtDescription}</td>
																<td><a href="/admin/editDistrict?id=${district.id }"><i
																		class="fa fa-edit" aria-hidden="true"></i></a></td>
																<td><a href="/admin/deleteDistrict?id=${district.id }"><i
