    ...
    <section class="content-header">
          <h1>Manage Village</h1>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="/admin/viewVillage">View Village</a></li>
				</ol>
			</section>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">View Village</h3>
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						<%@taglib uri="http://java.sun.com/jstl/core_rt"
															prefix="c"%>
							<c:forEach items="${villageList}" var="village" varStatus="j">
							<tr>
																<td>${j.count}</td>
																<td>${village.villageName }</td>
																<td>${village.districtVO.districtName}</td>
																<td>${village.stateVO.stateName }</td>
																<td>${village.countryVO.countryName}</td>
																
																<td>${village.villageDescription}</td>
																<td><a href="/admin/editVillage?id=${village.id }"><i
																		class="fa fa-edit" aria-hidden="true"></i></a></td>
																<td><a href="/admin/deleteVillage?id=${village.id }"><i
