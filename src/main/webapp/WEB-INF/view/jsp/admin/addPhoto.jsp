...
<head>
  <meta charset="utf-8">
    ...
    <title>Admin Satellite-Photos</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Manage Photos</a></li>
      ...
      <div class="box">
       <!--  <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<f:form novalidate="novalidate"  action="/addPhoto" method="post" enctype="multipart/form-data" modelAttribute="photoVO"  >
			 ...
			 <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
				<%-- <div class="col-lg-12 col-12">								
						<div class="form-group" style="margin-bottom: 3.429rem;">
							...
							<h5> Season <span class="text-danger">*</span></h5>
							<div class="controls">
								<f:select path="cropSeason" name="select" id="select" required="required" class="form-control"  data-validation-required-message="season is required">
									
									<f:option value="Spring">Spring</f:option>
									<f:option value="Summer">Summer</f:option>
									<f:option value="Monsoon">Monsoon</f:option>
									<f:option value="Autumn">Autumn</f:option>
									<f:option value="Winter">Winter</f:option>
						...
						<div class="form-group" style="margin-bottom: 3.429rem;">
							<h5>Photo-Description <span class="text-danger">*</span></h5>
							<div class="controls">
								<f:textarea path="photoDescription" name="photoDescription" id="textarea" class="form-control" required="required" data-validation-required-message="Photo description is required"  placeholder=" Description"></f:textarea>
							</div>
						</div>
						
						<div class="form-group"style="margin-bottom: 3.429rem;">
							<h5>Photo Of Crop <span class="text-danger">*</span></h5>
							<div class="controls">
								<input type="file" multiple="multiple" name="cropFiles" class="form-control" required="required"> </div>
						</div>
