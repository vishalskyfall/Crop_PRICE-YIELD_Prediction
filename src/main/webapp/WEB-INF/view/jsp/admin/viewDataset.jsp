		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="/admin/viewDataset">View Dataset</a></li>
				</ol>
			</section>
				...
				<div class="row">
								...
								<div class="box">
										<div class="box-header with-border">
											<h3 class="box-title">View Dataset</h3>
							...
							<th>Salary</th> -->
													...
													<tbody>
														<%@taglib uri="http://java.sun.com/jstl/core_rt"
															prefix="c"%>
														<c:forEach items="${datasetList}" var="dataset" varStatus="j">
															<tr>
																<td>${j.count}</td>
																<td>${dataset.datasetName}</td>
																<td><a href="${dataset.datasetLink}"> <i class="fa fa-paperclip" aria-hidden="true"> </i>		View</a></td>
																<td><a href="/admin/deleteDataset?id=${dataset.id}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
															</tr>
														</c:forEach>
