    ...
    <section class="content-header">
           <h1>Manage Crops</h1>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="/admin/viewCrop">View Crops</a></li>
				</ol>
			</section>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">View Crops</h3>
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						<%@taglib uri="http://java.sun.com/jstl/core_rt"
															prefix="c"%>
							<c:forEach items="${cropList}" var="crop" varStatus="j">
								<tr>
								<td>${j.count}</td>
								<td>${crop.cropSeason}</td>
								<td>${crop.cropName}</td>
								<td><a href="/admin/viewImage?id=${crop.id}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
								<td><a href="/admin/editCrop?id=${crop.id }"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
								<td><a href="/admin/deleteCrop?id=${crop.id}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
								</tr>
							</c:forEach>
					</tbody>
					<tfoot>
