  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Manage District</a></li>
        <li class="breadcrumb-item active"><a href="/admin/loadDistrict"> Add District</a></li>
      </ol>
    </section>
      ...
      <div class="box">
       <!--  <div class="box-header with-border">
        ...
        <div class="box-body">
         <div class="row">
         <div class="col">
					<f:form novalidate="novalidate"  action="/admin/addDistrict" modelAttribute="districtVO"  >
			...
			<div class="form-group" style="margin-bottom: 3.429rem;">
			 <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
				<div class="col-lg-12 col-12">
							...
							<div class="controls">
								<f:input path="districtName" placeholder="District Name" type="text" name="text" class="form-control" required="required" data-validation-required-message="district name is required"></f:input> </div>
							<!-- <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> -->
						</div>
						
						<div class="form-group" style="margin-bottom: 3.429rem;">
							<h5>District Description <span class="text-danger">*</span></h5>
							<div class="controls">
								<f:textarea path="districtDescription" name="textarea" id="textarea" class="form-control" required="required" placeholder="State Description" data-validation-required-message="district description is required"></f:textarea>
							</div>
						</div>
						<!-- 
