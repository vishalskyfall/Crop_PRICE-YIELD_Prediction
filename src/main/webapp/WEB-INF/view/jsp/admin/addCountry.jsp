    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Manage Country</a></li>
         <li class="breadcrumb-item active"><a href="/admin/loadCountry"> Add Country</a></li>
      </ol>
    </section>
      ...
      <div class="box">
       <!--  <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<f:form novalidate="novalidate" action="/admin/addCountry" modelAttribute="countryVO">
            	<f:hidden path="id"/>
				  <div class="row">
					<div class="col-lg-12 col-16">						
						<div class="form-group" style="margin-bottom: 3.429rem;">
							...
							<div class="controls">
								<f:input type="text" placeholder="Country Name" path="countryName" class="form-control" required="required" data-validation-required-message="Country name is required"></f:input> </div>
							<!-- <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> -->
						</div>
						<div class="form-group" style="margin-bottom: 3.429rem;">
							<h5>Country Description <span class="text-danger">*</span></h5>
							<div class="controls">
								<f:textarea path="countryDescription" name="countryDescription" id="textarea" class="form-control" required="required" data-validation-required-message="Country description is required"  placeholder="Country Description"></f:textarea>
							</div>
						</div>
						<!-- 
