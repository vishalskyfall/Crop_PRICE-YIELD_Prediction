						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="10">Junagarh</option>
												<option value="11">Kachchh</option>
												<option value="12">Kheda</option>
												<option value="13">Mehsana</option>
												<option value="14">Morbi</option>
												<!-- <option value="15">Narmada</option>
												<option value="16">Navsari</option> -->
												<option value="15">Panchmahals</option>
												<option value="16">Patan</option>
												<option value="17">Porbandar</option>
												<option value="18">Rajkot</option>
												<option value="19">Sabarkantha</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												...
												<option value="1">Castor seed</option>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Castor">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
