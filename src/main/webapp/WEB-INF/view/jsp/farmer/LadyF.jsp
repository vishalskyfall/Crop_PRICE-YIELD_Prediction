...
<title>Ladis Finger Prices</title>
<!-- Bootstrap 4.1-->
<link rel="stylesheet"
          ...
          <h6 class="box-subtitle">Bootstrap Form Validation check the <a class="text-warning" href="http://reactiveraven.github.io/jqBootstrapValidation/">official website </a></h6>
			...
			<ul class="box-controls pull-right">
			  ...
			  <li><a class="box-btn-fullscreen" href="#"></a></li>
					...
					<div class="box-header with-border">
						<h3 class="box-title">Ladis Finger</h3>
						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="6">Botad</option> -->
												<option value="5">Dahod</option>
												<option value="6">Gandhinagar</option>
												<!-- <option value="9">Jamnagar</option> -->
												<option value="7">Junagarh</option>
												<option value="8">Kachchh</option>
												<option value="9">Kheda</option>
												<option value="10">Mehsana</option>
												<option value="11">Morbi</option>
												<!-- <option value="15">Narmada</option> -->
												<option value="12">Navsari</option>
												<option value="13">Panchmahals</option>
												<option value="14">Patan</option>
												<option value="15">Rajkot</option>
												<option value="16">Sabarkantha</option>
												<option value="17">Surat</option>
												<option value="18">Surendranagar</option>
												<option value="19">The Dangs</option>
												<option value="20">Vadodara(Baroda)</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												...
												<option value="1">Bhindi</option>
												<option value="0">Other</option>
												<!-- <option value="28">Rajasthan Tukdi</option>
												<option value="20">Lokwan Gujrat</option>
												<option value="27">PISSI</option>
												<option value="15">Local</option>
												<option value="5">Bansi</option>
												<option value="14">Kalyan</option>
												<option value="17">Lok-1</option>
												<option value="13">Hybrid</option>
												<option value="0">Average</option>
												<option value="22">Medium</option>
												<option value="25">Milbar</option>
												<option value="10">Deshi</option>
												<option value="23">Medium Fine</option>
												<option value="29">Sechor No. 1</option>
												<option value="32">Sonalika</option>
												<option value="24">Mexican</option> -->
											</select>
										</div>
									</div>
									</div>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Ladis Finger">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
