						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="5">Kheda</option>
												<option value="6">Mehsana</option>
												<!-- <option value="14">Morbi</option> -->
												<option value="7">Narmada</option>
												<option value="8">Navsari</option>
												<option value="9">Panchmahals</option><!-- 
												...
												<option value="10">Vadodara(Baroda)</option>
												<option value="11">Valsad</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												...
												<option value="5">IR-8</option>
												<option value="11">Parmal</option>
												<option value="9">Masuri</option>
												<option value="12">Super Fine</option>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Rice">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
