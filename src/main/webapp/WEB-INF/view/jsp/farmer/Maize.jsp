						...
						<div class="row">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="11">Morbi</option>
												 <option value="12">Narmada</option> 
												 <option value="13">Panchmahals</option>
												<!--<option value="15">Patan</option> -->
												<option value="14">Porbandar</option>
												...
												<option value="19">Vadodara(Baroda)</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												class="form-control"
												data-validation-required-message="select year is required">
												<option value="0">Deshi Red</option>
												<option value="13">Yellow</option>
												<option value="4">Hybrid</option>
												<option value="11">White (SAFED)</option>
												<option value="9">Other</option>
												<option value="1">Deshi White</option>
												<option value="6">Hybrid/Local</option>
												<option value="3">Gajjar</option>
												<option value="10">Red</option>
												<option value="5">Hybrid Red (Cattle Feed)</option>
											</select>
										</div>
									</div>
									</div>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Maize">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
