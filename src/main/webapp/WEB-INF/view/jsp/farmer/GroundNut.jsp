          ...
          <h6 class="box-subtitle">Bootstrap Form Validation check the <a class="text-warning" href="http://reactiveraven.github.io/jqBootstrapValidation/">official website </a></h6>
			...
			<ul class="box-controls pull-right">
			  ...
			  <li><a class="box-btn-fullscreen" href="#"></a></li>
					...
					<div class="box-header with-border">
						<h3 class="box-title">GroundNut</h3>
						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												class="form-control"
												data-validation-required-message="select year is required">
												<option value="1">Big (With Shell)</option>
												<option value="2">Bold</option>
												<option value="5">G20</option>
												<option value="11">Local</option>
												<option value="13">Other</option>
												<option value="7">Groundnut seed</option>
												<option value="12">M-37</option>
												<option value="3">Bold Kernel</option>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="GroundNut">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
