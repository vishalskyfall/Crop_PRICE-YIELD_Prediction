...
<aside class="main-sidebar" >
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!--  <li class="header nav-small-cap">Farmer</li>(Personal) -->
        <li class="active">
          <a href="/farmer/index">
       ...
       <!--  <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadCountry"><i class="fa fa-circle-thin"></i>Add Country</a></li>
            <li><a href="/viewCountry"><i class="fa fa-circle-thin"></i>View Country</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-flag-o"></i> <span>Manage State</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/loadState"><i class="fa fa-circle-thin"></i>Add State</a></li>
            <li><a href="/viewState"><i class="fa fa-circle-thin"></i>View State</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadDistrict"><i class="fa fa-circle-thin"></i>Add District</a></li>
            <li><a href="/viewDistrict"><i class="fa fa-circle-thin"></i>View District</a></li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadVillage"><i class="fa fa-circle-thin"></i>Add Village</a></li>
            <li><a href="/viewVillage"><i class="fa fa-circle-thin"></i>View Village</a></li>
       ...
       <!--  <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-thin"></i>View Farmers</a></li>
		...
		<!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadCrop"><i class="fa fa-circle-thin"></i>Add Crop</a></li>
            <li><a href="/viewCrop"><i class="fa fa-circle-thin"></i>View Crops</a></li>
       ...
       <!--  <li class="treeview">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Future Suggestions</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/loadPrices"><i class="fa fa-circle-thin"></i>Future Price Prediction of Crops</a></li>
            <li><a href="/viewDataset"><i class="fa fa-circle-thin"></i>Future Yield Prediction Of Crops</a></li>
           </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadComplaint"><i class="fa fa-circle-thin"></i>Add Complaint</a></li>
            <li><a href="/farmer/viewComplaint"><i class="fa fa-circle-thin"></i>View Complaint</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/loadFeedback"><i class="fa fa-circle-thin"></i>Add Feedback</a></li>
            <li><a href="/farmer/viewFeedback"><i class="fa fa-circle-thin"></i>View Feedback</a></li>
          </ul>
        </li>
