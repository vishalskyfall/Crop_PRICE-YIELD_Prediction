						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="2">Banaskanth</option>
												<option value="3">Bharuch</option>
												<option value="4">Bhavnagar</option>
												<option value="5">Botad</option>
												<option value="6">Gandhinagar</option>
												<option value="7">Jamnagar</option>
												<option value="8">Junagarh</option>
												<option value="9">Kachchh</option>
												<option value="10">Kheda</option>
												<option value="11">Mehsana</option>
												<option value="12">Morbi</option>
												<option value="13">Narmada</option>
												<option value="14">Panchmahals</option>
												<option value="15">Patan</option>
												<option value="16">Porbandar</option>
												<option value="17">Rajkot</option>
												<option value="18">Sabarkantha</option>
												<option value="19">Surat</option>
												<option value="20">Surendranagar</option>
												<option value="21">Vadodara(Baroda)</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												class="form-control"
												data-validation-required-message="select year is required">
												<option value="25">Shanker 4 31mm FIne</option>
												<option value="26">Shanker 6 (B) 30mm FIne</option>
												<option value="3">Bunny</option>
												<option value="14">H.B  (Ginned)</option>
												<option value="15">H.B (Unginned)</option>
												<option value="7">Cotton (Unginned)</option>
												<option value="20">Local</option>
												<option value="9">Desi</option>
												<option value="11">G-6</option>
												<option value="20">Local</option>
												<option value="13">H-6</option>
												<option value="22">Narma BT Cotton</option>
												<option value="23">Other</option>
												<option value="24">RCH-2</option>
												<option value="27">Suvin 40mm(F)</option>
												<option value="28">V-797 22mm FIne</option>
												<option value="29">Y-1</option>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Cotton">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
