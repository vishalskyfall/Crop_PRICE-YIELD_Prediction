						...
						<div class="row">
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="District" id="District" required="required"
												...
												<option value="18">Patan</option>
												<option value="19">Porbandar</option>
												<option value="20">Rajkot</option>
												<option value="21">Surat</option>
												<option value="22">Surendranagar</option>
												<option value="23">Vadodara(Baroda)</option>
									...
									<div class="form-group" style="margin-bottom: 3.429rem;">
										...
										<div class="controls">
											<select name="Variety" id="Variety" required="required"
												class="form-control"
												data-validation-required-message="select year is required">
												<option value="30">Sharbati</option>
												<option value="19">Lokwan</option>
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-4">
										<input type="hidden" name="crop" value="Wheat">
										<button type="submit" class="btn btn-info">Submit</button>
										</div>
										<div class="col-sm-4">
										<!-- <button type="submit" class="btn btn-info">Submit</button> -->
